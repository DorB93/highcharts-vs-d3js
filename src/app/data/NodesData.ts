export default [
    ...
    {id: 'API2', name: 'Django', alert: false, to: ['SQL1','MGUS1']},
    {id: 'API3', name: 'Azure', alert: false, to: ['MDB1']},
    {id: 'MGUS1', name: 'Mongoose', alert: true, to: ['MDB2','API1']},
    {id: 'MSSQL1', name: 'MSSQL', alert: true, to: ['SQL2']},
    {id: 'SQL1', name: 'MySQL', alert: false, to: ['API2']},
    {id: 'SQL2', name: 'MySQL', alert: false, to: []},
